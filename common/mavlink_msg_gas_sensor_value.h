...
typedef struct __mavlink_gas_sensor_value_t {
 uint64_t PRESSURE; /*<  The unit is pa*/
...
#define MAVLINK_MSG_ID_GAS_SENSOR_VALUE_LEN 39
#define MAVLINK_MSG_ID_GAS_SENSOR_VALUE_MIN_LEN 39
#define MAVLINK_MSG_ID_10000_LEN 39
#define MAVLINK_MSG_ID_10000_MIN_LEN 39

#define MAVLINK_MSG_ID_GAS_SENSOR_VALUE_CRC 250
#define MAVLINK_MSG_ID_10000_CRC 250
...
#define MAVLINK_MESSAGE_INFO_GAS_SENSOR_VALUE { \
    ...
    "GAS_SENSOR_VALUE", \
    11, \
    {  { "PM25", NULL, MAVLINK_TYPE_UINT16_T, 0, 32, offsetof(mavlink_gas_sensor_value_t, PM25) }, \
         { "PM10", NULL, MAVLINK_TYPE_UINT16_T, 0, 34, offsetof(mavlink_gas_sensor_value_t, PM10) }, \
         { "SO2", NULL, MAVLINK_TYPE_UINT32_T, 0, 8, offsetof(mavlink_gas_sensor_value_t, SO2) }, \
         { "VOC", NULL, MAVLINK_TYPE_UINT32_T, 0, 12, offsetof(mavlink_gas_sensor_value_t, VOC) }, \
         { "NO2", NULL, MAVLINK_TYPE_UINT32_T, 0, 16, offsetof(mavlink_gas_sensor_value_t, NO2) }, \
         { "CO", NULL, MAVLINK_TYPE_UINT32_T, 0, 20, offsetof(mavlink_gas_sensor_value_t, CO) }, \
         { "NH3", NULL, MAVLINK_TYPE_UINT32_T, 0, 24, offsetof(mavlink_gas_sensor_value_t, NH3) }, \
         { "O3", NULL, MAVLINK_TYPE_UINT32_T, 0, 28, offsetof(mavlink_gas_sensor_value_t, O3) }, \
         { "PRESSURE", NULL, MAVLINK_TYPE_UINT64_T, 0, 0, offsetof(mavlink_gas_sensor_value_t, PRESSURE) }, \
         { "HUMIDITY", NULL, MAVLINK_TYPE_UINT8_T, 0, 38, offsetof(mavlink_gas_sensor_value_t, HUMIDITY) }, \
         { "TEMPERATURE", NULL, MAVLINK_TYPE_UINT16_T, 0, 36, offsetof(mavlink_gas_sensor_value_t, TEMPERATURE) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_GAS_SENSOR_VALUE { \
...
static inline uint16_t mavlink_msg_gas_sensor_value_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint16_t PM25, uint16_t PM10, uint32_t SO2, uint32_t VOC, uint32_t NO2, uint32_t CO, uint32_t NH3, uint32_t O3, uint64_t PRESSURE, uint8_t HUMIDITY, uint16_t TEMPERATURE)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_GAS_SENSOR_VALUE_LEN];
    _mav_put_uint64_t(buf, 0, PRESSURE);
    _mav_put_uint32_t(buf, 8, SO2);
    _mav_put_uint32_t(buf, 12, VOC);
    _mav_put_uint32_t(buf, 16, NO2);
    _mav_put_uint32_t(buf, 20, CO);
    _mav_put_uint32_t(buf, 24, NH3);
    _mav_put_uint32_t(buf, 28, O3);
    _mav_put_uint16_t(buf, 32, PM25);
    _mav_put_uint16_t(buf, 34, PM10);
    _mav_put_uint16_t(buf, 36, TEMPERATURE);
    _mav_put_uint8_t(buf, 38, HUMIDITY);
...
static inline void mavlink_msg_gas_sensor_value_send(mavlink_channel_t chan, uint16_t PM25, uint16_t PM10, uint32_t SO2, uint32_t VOC, uint32_t NO2, uint32_t CO, uint32_t NH3, uint32_t O3, uint64_t PRESSURE, uint8_t HUMIDITY, uint16_t TEMPERATURE)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_GAS_SENSOR_VALUE_LEN];
    _mav_put_uint64_t(buf, 0, PRESSURE);
 ...
 */
static inline void mavlink_msg_gas_sensor_value_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint16_t PM25, uint16_t PM10, uint32_t SO2, uint32_t VOC, uint32_t NO2, uint32_t CO, uint32_t NH3, uint32_t O3, uint64_t PRESSURE, uint8_t HUMIDITY, uint16_t TEMPERATURE)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 */
static inline uint64_t mavlink_msg_gas_sensor_value_get_PRESSURE(const mavlink_message_t* msg)
{
